...
import Card from '../../Components/CardLg';
  ...
  <>
    ...
    <Card>
      ...
      <div class="col-lg-6 pl-lg-4 mt-lg-0 mt-4">
        <img src="images/template2.jpg" alt="" class="img-fluid rounded" />
      </div>
    </Card>
    <Card>
      <div class="col-lg-6 pr-lg-4">
        <img src="images/template1.jpg" alt="" class="img-fluid rounded" />
      </div>
    ...
    <Card allClass='feature-3 text-center' hasTitle={true} titleClass='block__title mb-lg-4' title='Content Block Features' >
    ...
    <Card allClass='cwp23-content' hasTitle={true} titleClass='block__title mb-lg-4' title='Content Block Features with photo' >
      ...
      <div class="col-md-6 mt-md-0 mt-5 cwp23-img">
        <img src="images/template2.jpg" class="img-fluid rounded" alt="" />
      </div>
    </Card>
  </>
);